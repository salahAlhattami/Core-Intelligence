...
- [ ] P1 — Enrich public business contacts in batches of about 15 companies per target per run.
- [ ] P2 — Implement deduplication, evidence coverage, and quality validation scripts.
